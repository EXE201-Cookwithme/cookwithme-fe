...
const postId = "67b0707c4238ccc5a7e6d167";
        ...
        <div className="col-span-9 bg-white p-5 rounded-md shadow-md">
          ...
          <div className="flex flex-col text-gray-700 leading-relaxed gap-5">
            <h1 className="text-2xl font-bold text-gray-800">
              Pasta Carbonara (Ý) – Làm sao để sốt kem mịn mà không bị vón cục?
            </h1>
            <div className="mt-4">
              <h2 className="text-lg font-semibold text-red-600">Mẹo hay:</h2>
              <p className="mt-2">
                🍝 Dùng lòng đỏ trứng và phô mai Pecorino Romano thay vì kem
                tươi để có sốt Carbonara đúng chuẩn.
              </p>
            </div>
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside mt-2 space-y-2">
                <li>
                  ✅ Tắt bếp trước khi cho hỗn hợp trứng vào để tránh bị vón
                  cục.
                </li>
                <li>✅ Trộn nhanh tay với mì còn nóng để sốt bám đều.</li>
                <li>
                  ✅ Thêm một chút nước luộc mì vào sốt để tạo độ sánh mịn.
                </li>
              </ul>
            </div>
          </div>
